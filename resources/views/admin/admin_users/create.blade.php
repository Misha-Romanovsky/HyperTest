    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="mt-8">
            <form enctype="multipart/form-data" class="space-y-5 mt-5" method="POST" action="{{ isset($user) ? route("admin.admin_users.update", $user->id) : route("admin.admin_users.store") }}">
                ...
                <input name="password_confirmation" type="password" autocomplete="new-password"  class="w-full h-12 border border-gray-800 rounded px-3 @error('password') border-red-500 @enderror" placeholder="Password confirmation" value="" />
